        ...
        {filteredAndSorted.map((event) => (
          <Card key={event.id}>
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-600">Duration: <strong>{event.duration} min</strong></span>
              <span className="text-sm text-gray-600">{event.moistureBefore}% → {event.moistureAfter}%</span>
            </div>
          </Card>
        ))}
